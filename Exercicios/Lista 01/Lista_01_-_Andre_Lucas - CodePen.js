...
while (exerciseNumber <= 16) {
     ...
     switch (exerciseNumber) {
          ...
          //* 10
               ...
               for (let contador = 1; contador <= 10; contador++) {
                    ...
                    alert(`${contador}º : ${numeroInteiro}`);
               } 
          ...
          //* 11
               ...
               alert("O valor fornecido não é válido.");
          ...
          //* 12
               ...
               for (let num = 1000; num <= 1999; num++) {
                    if (num % 11 === 5){
                         ...
                         alert(`Números divididos por 11 que possuem resto igual a 5: ${num}`);
                    }
               }
          ...
          //* 13
               ...
               for (let contagem = 1; contagem <= 5; contagem++) {
                    ...
                    for (let indice = 1; indice <= nTabuada; indice++) {
                         ...
                         alert(` ${indice} x ${nTabuada} = ${result}`);
                    }
                    console.log("\n");
                    alert("\n");
               }
          ...
          //* 16
               ...
               while (contador < 50) {
                    ...
                    if (ehPrimo) {
                         ...
                         alert(` ${contador}º  número primo (> 100):  ${numero}\n`);
                    }
     ...
     exerciseNumber < 16 ? console.log("\nPressione Enter para o próximo exercício...") : undefined;
     exerciseNumber < 16 ? alert("\nPressione Enter para o próximo exercício...") : undefined;
     exerciseNumber++;
}
